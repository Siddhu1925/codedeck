...
function SignIn() {
  ...
  return (
    <div className='flex flex-col w-6/12 p-4 mx-auto justify-center'>
      ...
      <button onClick={signInWithGithub} form='hook-form' className='w-full border-2 bg-white p-3 mt-8 font-semibold shadow-lg rounded-lg text-center flex justify-center'> <span className="flex items-center gap-3"><GoMarkGithub style={{ fontSize: "2rem" }} /> Sign In with Github</span> </button>
